...
namespace Mindmecn\MarkdownBundle\API\Crud;
...
class MarkdownCrud
{
    ...
    public function preCreate(CreateEvent $event)
    {
        ...
        if (!in_array(Options::NO_LOG, $options)) {
            $this->eventDispatcher->dispatch(
                'log',
                'Mindmecn\\MarkdownBundle\\Event\\Log\\LogMarkdownCreateEvent',
    ...
    public function postUpdate(UpdateEvent $event)
    {
        ...
        $this->eventDispatcher->dispatch(
            'log',
            'Mindmecn\\MarkdownBundle\\Event\\Log\\LogMarkdownEditEvent',
            [$markdown->getAggregate(), $markdown]
        );
    }
    ...
    public function preDelete(DeleteEvent $event)
    {
        ...
        $this->eventDispatcher->dispatch(
            'log',
            'Mindmecn\\MarkdownBundle\\Event\\Log\\LogMarkdownDeleteEvent',
            [$markdown->getAggregate(), $markdown]
        );
    }
}
