...
namespace Mindmecn\MarkdownBundle\Event\Log;

use Claroline\CoreBundle\Entity\Resource\ResourceNode;
use Claroline\CoreBundle\Event\Log\LogGenericEvent;
use Claroline\CoreBundle\Event\Log\NotifiableInterface;

class LogEditResourceMktemplateEvent extends LogGenericEvent implements NotifiableInterface
{
    const ACTION = 'resource-mktemplate-update';
